...
vec3 calculateDiffusion(Material material, vec2 textCoord)
{
    ...
    texture_color += material.diff_map_1_strength * vec3(texture(material.diff_map_1, textCoord));
    texture_color += material.diff_map_2_strength * vec3(texture(material.diff_map_2, textCoord));
